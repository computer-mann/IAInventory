...
namespace WebApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,Description,Timestamp")] Category category)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,Description,Timestamp")] Category category)
        {
